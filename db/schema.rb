...
ActiveRecord::Schema[7.0].define(version: 2023_05_03_112601) do
  ...
  create_table "product_carts", force: :cascade do |t|
    t.integer "userdevise_id", null: false
    t.integer "product_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "quantity", default: 0
    t.index ["product_id"], name: "index_product_carts_on_product_id"
    t.index ["userdevise_id"], name: "index_product_carts_on_userdevise_id"
  end
  ...
  create_table "user_cart_items", force: :cascade do |t|
    t.integer "user_devise_id", null: false
    t.integer "product_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id"], name: "index_user_cart_items_on_product_id"
    t.index ["user_devise_id"], name: "index_user_cart_items_on_user_devise_id"
  end

  create_table "user_product_carts", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "product_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "product_carts", "userdevises"
  add_foreign_key "user_cart_items", "products"
  add_foreign_key "user_cart_items", "user_devises"
  add_foreign_key "user_product_carts", "products"
  add_foreign_key "user_product_carts", "users"
